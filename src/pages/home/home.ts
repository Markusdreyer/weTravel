...
export class HomePage {
  ...
  constructor(public navCtrl: NavController,
    ...
    this.restaurants = [
      ...
      new Restaurant("Upkvikking", "../../assets/imgs/thumbnail/Restaurant/crop2.jpg", "$$$$", "Stranden 31", "0150 Oslo", "3", "10-23"),
    ...
    this.shops = [
      new Shop("Old Quarters", "../../assets/imgs/thumbnail/Shopping/crop.jpg", "$$$", "Plassen 1,", "0010 Oslo", "3", "09-20"),
      new Shop("ExStatic Mall", "../../assets/imgs/thumbnail/Shopping/crop1.jpg", "$$", "Dronning Eufemiasgate 7,", "0541 Oslo", "5", "10-19"),
      new Shop("Wing Market", "../../assets/imgs/thumbnail/Shopping/crop2.jpg", "$$$$", "Karl Johans Gate 2,", "0190 Oslo", "4", "10-20"),
      ...
      new Shop("Kowloon Street", "../../assets/imgs/thumbnail/Shopping/crop5.jpg", "$", "Passasjen 3,", "0103 Oslo", "5", "12-22")
    ...
    this.activities = [
      ...
      new Activity("Holmenkollen", "./../assets/imgs/thumbnail/Activities/crop3.jpg", "$$$", "Holmenkollen", "0345 Oslo", "5", "09-21"),
